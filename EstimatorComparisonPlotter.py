...
LABELS = [
    "Our estimator",
    "SGT binomial, our analysis",
    "SGT binomial, their analysis",
    "Null estimator",
]
...
def plot_comparison_grid(vs_t_csv="rmse_vs_t.csv",
    ...
    for j, r in enumerate(rs):
        ...
        h1 = _scatter_masked(ax, t, d["sqrt_star"], label=LABELS[0], marker="o")
        h2 = _scatter_masked(ax, t, d["sqrt_HO"],   label=LABELS[1], marker="s")
        h3 = _scatter_masked(ax, t, d["sqrt_f"],    label=LABELS[2], marker="^")
        h4 = _scatter_masked(ax, t, d["sqrt_g"],    label=LABELS[3], marker="x")
    ...
    axes[0, 0].set_ylabel("Worst case RMSE")
    ...
    for j, tval in enumerate(ts):
        ...
        ax.scatter(r, d["sqrt_star"], label=LABELS[0], marker="o")
        ax.scatter(r, d["sqrt_HO"],   label=LABELS[1], marker="s")
        ax.scatter(r, d["sqrt_f"],    label=LABELS[2], marker="^")
        ax.scatter(r, d["sqrt_g"],    label=LABELS[3], marker="x")
    ...
    axes[1, 0].set_ylabel("Worst case RMSE")

    # ---------------- Title & legend ----------------
    fig.suptitle("Worst Case RMSE Comparison", y=0.98)
